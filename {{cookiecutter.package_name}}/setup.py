...
ingestfile='{{ cookiecutter.ingestldd_filename }}'
...
setup(
    ...
    url="https://github.com/nasa-pds-data-dictionaries/{{ cookiecutter.package_name }}",
    license='OSI Approved Apache Software License',

    author="PDS Operator",
    author_email="pds_operator@jpl.nasa.gov",

    description="The PDS4 {{ cookiecutter.dictionary_name }} Local Data Dictionary",
